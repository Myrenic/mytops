// Regenerates base/shacdn-webui.configmap.json from the vite output in
// base/www, and base/shacdn-workplace-api.configmap.json from api/server.mjs.
...
const spaOut = join(base, "shacdn-webui.configmap.json")
...
const apiOut = join(base, "shacdn-workplace-api.configmap.json")
const serverCode = await readFile(serverSrc, "utf8")

const apiConfigMap = {
  apiVersion: "v1",
  kind: "ConfigMap",
  metadata: { name: "shacdn-workplace-api" },
